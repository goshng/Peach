...
#define RELEASE_DATE " April 11, 2011"
...
// JH 4/1/11  added this from Vitor for the bug fixes regarding realloc() use
// VS modified the STARTMIGMAX, ADDMIGMAX and ABSMIGMAX
...
#define STARTMIGMAX 100        /* max number per edge when trees are first built */
#define ADDMIGMAX 50          /* max of number of mirgrations that can be added by poisson generator */
#define ABSMIGMAX  1000         /* absolute maximum # of migration events allowed  -  is 5000 too large? */
...
/*  jhey personal options using -jh flag
    ...
    */
enum
{ SWINPUTOPTION = 0,WRITEMIGRATIONNAME=1,WRITEPDGPGFILE = 2,JHOPTIONNUMBER };
...
// 4/1/11  added these new functions from Vitor to trap realloc errors
