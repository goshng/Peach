...
# SL2.40ch00      ITAG_eugene     mRNA    16437   18189   .       +       .
# ID=mRNA:Solyc00g005000.2.1;Name=Solyc00g005000.2.1;Note=Aspartic proteinase
# nepenthesin I (AHRD V1 **-- A9ZMF9_NEPAL)%3B contains Interpro domain(s)
# IPR001461  Peptidase A1 ;Ontology
    elsif (/\s+mRNA\s+\d+.*ID=mRNA:(Solyc.+);Name=Solyc/)
    {
      $locus2protein{$1} = $1;
    }
  }
